// ═══════════════════════════════════════════════════════
// js/pages/login.js — Tela de autenticação
// ═══════════════════════════════════════════════════════
import {
    ...
    <div class="login-wrap">
      <div class="login-card">
        ...
        <div class="login-brand">
          <span class="brand-icon" style="font-size:28px">✦</span>
          <div>
            <div class="font-serif" style="font-size:22px;font-weight:600;color:var(--noir)">Salão Premium</div>
        ...
        <div id="painelEntrar">
          ...
          <button class="btn btn-primary w-full mt-8" id="btnEntrar">Entrar</button>
          ...
          <div style="text-align:center;margin-top:12px">
            <a href="#" id="linkEsqueci" style="font-size:12px;color:var(--plum)">Esqueci minha senha</a>
          </div>
        </div>
        ...
        <div id="painelCadastrar" style="display:none">
          ...
          <button class="btn btn-primary w-full" id="btnCadastrar">Criar conta</button>

          <div class="login-divider"><span>ou</span></div>

          <button class="btn-google" id="btnGoogleCad">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.209 1.125-.843 2.078-1.796 2.716v2.258h2.908c1.702-1.567 2.684-3.874 2.684-6.615Z" fill="#4285F4"/>
              <path d="M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18Z" fill="#34A853"/>
              <path d="M3.964 10.71A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.71V4.958H.957A8.996 8.996 0 0 0 0 9c0 1.452.348 2.827.957 4.042l3.007-2.332Z" fill="#FBBC05"/>
